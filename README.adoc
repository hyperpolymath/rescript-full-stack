...
│                           PRESENTATION                               │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐ │
│  │  rescript-  │  │   rescript- │  │   @rescript │  │    Tauri    │ │
│  │     tea     │  │     jsx     │  │    /react   │  │   (Rust)    │ │
...
│                         COMPUTE (WASM)                               │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐ │
│  │    WASM     │  │   Shared    │  │  Dependency │  │    Code     │ │
│  │   Modules   │  │   Memory    │  │    Graph    │  │Fingerprint  │ │
...
deno install rescript @rescript/react
deno install rescript-tea cadre-tea-router
...
deno create-rescript-fullstack my-app

* you can use npm but it's crap
----
